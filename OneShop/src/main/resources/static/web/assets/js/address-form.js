...
(function () {
  ...
  window.addEventListener("DOMContentLoaded", async function () {
    ...
    const hProvince = document.querySelector('input[name="tinhThanh"]');
    const hDistrict = document.querySelector('input[name="quanHuyen"]');
    const hWard     = document.querySelector('input[name="phuongXa"]');
